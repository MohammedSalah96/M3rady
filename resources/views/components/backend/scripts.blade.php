...
<script src="{{url('public/backend/plugins/custom/datatables/datatables.bundle.js')}}"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Vendors(used by this page)-->

<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="{{url('public/backend/js/pages/widgets.js')}}"></script>
...
<script src="{{url('public/backend/scripts/main.js')}}" type="text/javascript"></script>
