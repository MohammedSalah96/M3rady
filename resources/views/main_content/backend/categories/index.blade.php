...
@if ($parentId)
<li class="breadcrumb-item">
    <a href="{{route('categories.index')}}" class="text-muted">{{_lang('app.categories')}}</a>
</li>
{!! $path !!}
@else  
<li class="breadcrumb-item">
    <a href="#">{{_lang('app.categories')}}</a>
</li>
@endif
...
@section('js')
<script src="{{url('public/backend/scripts/categories.js')}}" type="text/javascript"></script>
@endsection
...
<div class="row">
    <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12">
        <div class="card card-custom gutter-b">
            ...
            <form id="addEditCategoriesForm" enctype="multipart/form-data">
                <div class="card-body">
                    {{ csrf_field() }}
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">{{_lang('app.manage_categories')}}</h3>
                </div>
            </div>
