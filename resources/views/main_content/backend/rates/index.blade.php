...
@section('pageTitle', _lang('app.rates'))
...
<li class="breadcrumb-item">
    <a href="#">{{_lang('app.rates')}}</a>
</li>

@endsection

@section('js')
<script src="{{url('public/backend/scripts/rates.js')}}" type="text/javascript"></script>
@endsection
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">{{_lang('app.manage_rates')}}</h3>
        </div>
    </div>
