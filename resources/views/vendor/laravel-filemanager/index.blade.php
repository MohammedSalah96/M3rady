...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ url('public/vendor/laravel-filemanager/img/folder.png') }}">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="{{ url('public/vendor/laravel-filemanager/css/cropper.min.css') }}">
  <style>{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  {{-- <link rel="stylesheet" href="{{ asset('/vendor/laravel-filemanager/css/lfm.css') }}"> --}}
  <link rel="stylesheet" href="{{ url('public/vendor/laravel-filemanager/css/mfb.css') }}">
  <link rel="stylesheet" href="{{ url('public/vendor/laravel-filemanager/css/dropzone.min.css') }}">
...
<body>
  ...
  <div id="lfm-loader">
    <img src="{{url('public/vendor/laravel-filemanager/img/loader.svg')}}">
  </div>
  ...
  <script src="{{ url('public/vendor/laravel-filemanager/js/cropper.min.js') }}"></script>
  <script src="{{ url('public/vendor/laravel-filemanager/js/jquery.form.min.js') }}"></script>
  <script src="{{ url('public/vendor/laravel-filemanager/js/dropzone.min.js') }}"></script>
  <script>
  ...
  {{-- <script src="{{ url('public/vendor/laravel-filemanager/js/script.js') }}"></script> --}}
  <script>
    $.fn.fab = function () {
      var menu = this;
