...
class GroupsController extends BackendController {
    ...
    public function store(Request $request) {
        try {
            ...
            $this->groupRepository->create($request);
    ...
    public function update(Request $request, $id) {
        try {
            ...
            $this->groupRepository->update($request, $id, $group);
    ...
    public function destroy(Request $request,$id) {
        try {
            ...
            $this->groupRepository->delete($request, $id, $group);
    ...
    public function data(Request $request) {
        $groups = $this->groupRepository->dataTable($request);
                        ...
                        ->addColumn('options', function ($item) {
                            ...
                            if (\Permissions::check('groups', 'edit') || \Permissions::check('groups', 'delete')) {
                                if (\Permissions::check('groups', 'edit')) {
                                    $back .= '<a href="" data-toggle="tooltip" onclick="Groups.edit(this);return false;" data-id= "' . $item->id . '"  class="btn btn-sm btn-clean btn-icon mr-2" title="'. _lang('app.edit').'">
                                ...
                                if (\Permissions::check('groups', 'delete')) {
                                    $back .= '<a href="" data-toggle="tooltip" onclick="Groups.delete(this);return false;" data-id="' . $item->id . '" class="btn btn-sm btn-clean btn-icon" title="'._lang('app.delete').'">
                                                <span class="svg-icon svg-icon-md">
    ...
    private function getModules(){
        ...
        $modules = Config::get('modules.admin_modules');
